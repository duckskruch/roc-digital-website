...
import { ArrowLeft, ArrowUpRight, Workflow, CheckCircle, Clock, DollarSign, Shield, Settings, Users, Target } from 'lucide-react';
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
              <h2 style={{ fontSize: '24px', fontWeight: '600', marginBottom: '24px', color: 'var(--color-gray-900)' }}>
                Типы процессов, которые мы автоматизируем
              </h2>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                <div style={{ padding: '24px', background: 'var(--color-gray-50)', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    <Settings size={24} style={{ color: 'var(--color-blue-accent)' }} />
                    <h3 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-gray-900)' }}>Документооборот</h3>
                  </div>
                  <ul style={{ listStyle: 'none', padding: 0, color: 'var(--color-gray-600)' }}>
                    <li>• Обработка входящих документов</li>
                    <li>• Автоматическое извлечение данных</li>
                    <li>• Маршрутизация по отделам</li>
                    <li>• Контроль сроков исполнения</li>
                ...
                <div style={{ padding: '24px', background: 'var(--color-gray-50)', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    <Users size={24} style={{ color: 'var(--color-blue-accent)' }} />
                    <h3 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-gray-900)' }}>HR-процессы</h3>
                  </div>
                  <ul style={{ listStyle: 'none', padding: 0, color: 'var(--color-gray-600)' }}>
                    <li>• Обработка резюме и заявок</li>
                    <li>• Автоматическое планирование собеседований</li>
                    <li>• Онбординг новых сотрудников</li>
                    <li>• Учет рабочего времени</li>
                    <li>• Расчет зарплаты и премий</li>
                  </ul>
                </div>
                
                <div style={{ padding: '24px', background: 'var(--color-gray-50)', borderRadius: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    <Target size={24} style={{ color: 'var(--color-blue-accent)' }} />
                    <h3 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-gray-900)' }}>Продажи и CRM</h3>
                  </div>
                  <ul style={{ listStyle: 'none', padding: 0, color: 'var(--color-gray-600)' }}>
                    <li>• Обработка лидов и заявок</li>
                    <li>• Автоматическое создание сделок</li>
                    <li>• Напоминания о звонках</li>
            ...
            <div style={{ marginBottom: '40px' }}>
              ...
              <div style={{ display: 'grid', gap: '16px' }}>
                {[
                  { day: 'День 1-2', title: 'Анализ процессов', desc: 'Изучаем ваши бизнес-процессы и выявляем узкие места' },
                  { day: 'День 3-4', title: 'Настройка OCR', desc: 'Настраиваем распознавание документов под ваши форматы' },
